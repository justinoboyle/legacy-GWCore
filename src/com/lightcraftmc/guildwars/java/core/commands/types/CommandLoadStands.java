...
public class CommandLoadStands extends Command {

    @SuppressWarnings("deprecation")
    @Override
    public boolean onCommand(CommandSender sender, String label, String[] args) {
        String[] alts = new String[] { "loadstands" };
        boolean cont = false;
        for (String s : alts) {
        ...
        sender.sendMessage("§aSuccess > §7Loading armor stands...");
        ArmorStandSave.loadStands();
        return true;
    }
}
