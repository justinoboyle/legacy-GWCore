...
import com.lightcraftmc.guildwars.java.core.npc.types.lobby.messages.OopsMessageList;

public class Randy extends NPC {
    ...
    public String pickQuote() {
        return OopsMessageList.messages[rand.nextInt(OopsMessageList.messages.length - 1)];
    }
